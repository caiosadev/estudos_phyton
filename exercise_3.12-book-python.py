...
print("O tempo estimado da viagem é: %.2f horas" % tempo_viagem)
...
tempo_viagem = ((distancia / velocidade_media_hora) * 60) + (pedagios * tempo_pedagios) # *60 para converter em minutos
...
print("O tempo estimado da viagem é de: %.0f minutos, equivalente a %.0fh e %.0fm" % (tempo_viagem, tempo_horas, tempo_minutos))